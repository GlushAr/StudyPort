...
const SecondItemList = (props) => {
    ...
    return (
        <div className={classes.list}>
            {props.items.map(item => <SecondItem isLoad={props.isLoad} setFirstItemList={props.setSecondItemList} firstId={props.id} setItems={props.setItems} id={item.id} body={item}/>)}
