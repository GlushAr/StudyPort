...
const Item = (props) => {
    ...
    return (
        <div className={classes.tmTasklist}>
            ...
            <SecondItemList isLoad={props.body.type.toLowerCase()==='грузовой'} setSecondItemList={props.setSecondItemList} setItems={setSecondItems} id={props.id} setSecondModalVisible={props.setSecondModalVisible} setItemId={props.setItemId} items={secondItems}/>
        </div>
    );
};
